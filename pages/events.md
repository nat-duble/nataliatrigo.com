...
<div class="event-section">
  ...
  <div class="event">
    ...
    <ul class="event-dates">
      ...
      <li><span class="event-date">7 de mayo</span> Librería La Malinche, Barcelona</li>
      <li><span class="event-date">8 de mayo</span> La Central, Barcelona</li>
      <li><span class="event-date">9 de mayo</span> Librería Estrella Distante, Madrid</li>
    </ul>
  </div>
</div>
